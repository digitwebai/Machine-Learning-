...
DB_PASSWORD = os.environ.get('DB_PASSWORD', 'digitweb@2025')  # Use environment variable or fallback password
DB_NAME = 'Google_ads'  # Your Cloud SQL database name
DB_HOST = '34.118.200.124'  # Public IP from the image
...
def setup_database():
    ...
    try:
        ...
        #     # ssl={'ca': '/path/to/server-ca.pem', 'cert': '/path/to/client-cert.pem', 'key': '/path/to/client-key.pem'}
        # )
